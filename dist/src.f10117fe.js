...
function () {
  ...
  Client.prototype._handleOnMessage = function (args) {
  ...
  Client.prototype.onMessage = function (eventName, listener) {
  ...
  Client.prototype.once = function (eventName, listener) {
    this._emitter.once(eventName, listener);
  };

  Client.prototype.off = function (eventName, listener) {
    this._emitter.off(eventName, listener);
  };

  Client.prototype.isSubscrubed = function (topic) {
    if (topic === void 0) {
      topic = undefined;
    }
  ...
  Client.prototype.send = function (topic, message) {
    if (topic === void 0) {
      topic = "/";
    }
  ...
  Client.prototype.disconnect = function (topic) {
    if (topic === void 0) {
      topic = undefined;
    }
    ...
    if (topic) {
      ...
      Object.values(this._subscriptions).forEach(function (o) {
        return o.close();
      });
      this._subscriptions = {};
    }
...
var cb = new Client();
exports.default = cb;
},{"eventemitter3":"node_modules/eventemitter3/index.js"}],"src/index.ts":[function(require,module,exports) {
...
client_1.default.subscribe();
client_1.default.publish("/", {
  payload: "asdf"
});
global.client = client_1.default;
},{"./client":"src/client.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
